...
7. **Download `secret.yaml`**: Membuat manifest `stringData` dengan nama yang mengikuti **Secret Target Name** dan namespace kosong, lalu mengunduhnya langsung sebagai `secret.yaml`.
